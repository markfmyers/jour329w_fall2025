...
2. Places - Extract geographic locations and physical facilities (NOT schools):
   - Counties, towns, cities, neighborhoods
   - Physical facilities like libraries, community centers, parks, stadiums
   - SKIP: Individual schools (these are organizations, not places)
   - SKIP: Generic locations like "classroom" or distant places not central to coverage

3. Organizations - Extract education institutions and key partners:
   - Individual schools (high schools, middle schools, elementary schools) - SCHOOLS ARE ORGANIZATIONS
   ...
   - Key partners (county government, state education dept when involved in decisions)
